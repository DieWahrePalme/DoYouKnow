...
> See `.claude/rules/ecc/README.md` for project-specific deviations.
...
Origin: imported from github.com/affaan-m/ecc (rules/common/coding-style.md), commit bf70150
