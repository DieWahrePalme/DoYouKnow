...
- Rules: `.claude/rules/ecc/react-native/` (this project uses React Native, not web React — hooks/accessibility/performance sections above still apply; server/client-component and Next.js sections do not)
- Skills: `react-native-patterns`
- Origin: imported from github.com/affaan-m/ecc (agents/react-reviewer.md), commit bf70150
